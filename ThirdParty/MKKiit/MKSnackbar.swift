...
public class MKSnackbar: UIControl {
    ...
    private func setup() {
        ...
        self.backgroundColor = UIColor.init(colorLiteralRed: 61/255, green: 156/255, blue: 52/255, alpha: 1)
        ...
        if let actionButton = actionButton {
            ...
            actionButton.frame = CGRect.init(x: actionButton.frame.origin.x, y: actionButton.frame.origin.y, width: 48, height: 48)
            actionButton.setImage(UIImage.init(named: "HU"), forState: .Normal)
